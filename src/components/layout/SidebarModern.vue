<template>
  <div class="sidebar" :class="{ collapsed: isCollapsed }">
    ...
    <div class="sidebar-content">
      ...
      <!-- 对话列表区域 -->
      <div class="sessions-section" ref="sessionsSectionRef">
...
const navItems = [
  {
    path: "/home",
    label: "首页",
    icon: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 11l9-8 9 8"></path><path d="M5 10v10h14V10"></path></svg>',
  },
  {
    path: "/memory",
    label: "记忆",
...
const sessionsSectionRef = ref(null);
...
.sessions-section {
  ...
  padding: 0 0 0 8px;
  overflow: hidden;
  position: relative; /* 用于移动端自定义滚动条定位 */
}
